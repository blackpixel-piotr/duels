...
- Any numeric constant not sourced from a design doc must be marked provisional (code comment `// PROVISIONAL: <reason>`) and listed in the milestone findings file. Unflagged invented constants are defects.
